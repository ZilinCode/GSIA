...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--mask_type', default='my_mask',
                            help="select one  'single_bbox', 'bbox', 'free_form', 'my_mask'") 
        parser.add_argument('--checkpoints_dir', type=str, default='./Pluralistic-Inpainting-master/checkpoints', help='models are save here')
        ...
        # data pattern define
        parser.add_argument('--img_file', type=str, default='./data/data', help='training dataset')
